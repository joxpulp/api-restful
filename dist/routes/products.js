...
var products = new _productclass["default"](); // Endpoint GET para listar todos los productos
...
router.post('/productos/guardar', function (req, res) {
  var body = req.body;
  var newProduct = products.addProduct(body.title, body.price, body.thumbnail);
  res.json({
    product: newProduct
  });
